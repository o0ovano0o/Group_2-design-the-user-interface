...
const time= hours + ':' + min +" "+  date + '/' + month + '/' + year ;
    ...
    return (
      ...
      <Icon name="check" type="SimpleLineIcons" style={{color:'green',fontSize:120}}/>
      
      <Text style={styles.error}>Chuyển tiền thành công</Text> 
      </View>
      <View>
      ...
      <Text  style={{textAlign:'left'}}>Thời gian:</Text>
       ...
       <Text></Text>
       <Text>Tài khoản của bạn đã bị trừ tiền.Cảm ơn bạn đã sử dụng dịch vụ của chúng tôi.</Text>
      </View>
      </View>
      </View>
      </Content>
